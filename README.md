A basic but apt Guided Navigation Controller I developed for UAV's in a known environment. The map of the environment is made available using lib_gazebo 2D map plugin that
